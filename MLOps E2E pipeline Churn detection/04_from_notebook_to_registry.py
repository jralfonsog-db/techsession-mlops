...
model_details = mlflow.register_model(f"runs:/{run_id}/model", "field_demos_customer_churn")
...
model_version_details = client.get_model_version(name="field_demos_customer_churn", version=model_details.version)
...
request_transition(model_name = "field_demos_customer_churn", version = model_details.version, stage = "Staging")
...
model_comment(model_name = "field_demos_customer_churn",
             version = model_details.version,
             comment = comment)

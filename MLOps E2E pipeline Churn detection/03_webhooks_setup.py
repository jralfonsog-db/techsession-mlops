...
# DBTITLE 0,Install Databricks webhooks utility
...
create_notification_webhook(model_name = "field_demos_customer_churn", slack_url = "https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX")
...
# List
list_webhooks("field_demos_customer_churn")
...
# MAGIC **A:** Check out the <a href="https://databricks.com/blog/2020/11/19/mlflow-model-registry-on-databricks-simplifies-mlops-with-ci-cd-features.html" target="_blank"> blog post with the latest documtation</a>
